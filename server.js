  ...
  try {
    ...
    res.send(`
      ...
      <body>
        ...
        <h1>Dispatch Map</h1>
        <div class="subtitle">Interactive London map · Customer and technician postcode positions</div>
        ...
        ${
          customerPostcode
            ...
            : `<div class="notice">
                Enter a customer postcode to plot the job and nearby available locksmiths on the map.
              </div>`
        }
        ...
        <div class="map-layout">
          ...
          <div class="map-side-panel">
            ...
            <div class="map-note">
              ...
              This map uses technician current postcode first, then base postcode if current postcode is blank.
              <br><br>
              It does not show driving time yet. It shows postcode position and straight-line distance.
            </div>
          </div>
        </div>
